...
$sql = "SELECT * FROM cursos WHERE disponible='SI' ORDER BY fecha_inicio ASC";
...
<body class="dark:bg-background-dark font-display text-[#191014] antialiased min-h-screen flex flex-col">
            ...
            <div class="flex items-center gap-4 md:gap-6">
                ...
                <div class="flex items-center gap-3 pl-4 border-l border-white/20">
                    <!-- <button class="relative p-1 text-white/80 hover:text-white transition-colors">
                        ...
                        <span
                            class="absolute top-1 right-1 h-2 w-2 rounded-full bg-secondary border border-primary"></span>
                    </button> -->
                    <div
    ...
    <main class="flex-grow">
        <!-- Hero Section -->
        <section class="relative h-[480px] w-full overflow-hidden bg-gray-900">
            <!-- Background Image with Overlay -->
            <div class="absolute inset-0 z-0">
                <img class="h-full w-full object-cover opacity-100"
                    data-alt="Modern hospital building facade with glass windows" src="assets/imagenes/hospital.jpeg" />
                <div class="absolute inset-0 bg-gradient-to-r from-primary/90 to-primary/40 mix-blend-multiply"></div>
                <div class="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent"></div>
            </div>
            <!-- Content -->
            <div
                class="relative z-10 h-full max-w-[1280px] mx-auto px-4 md:px-8 flex flex-col justify-center text-white">
                <div class="max-w-2xl animate-fade-in-up">
                    <div
                        class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/20 backdrop-blur-sm border border-white/10 mb-6 w-fit">
                        <span class="w-2 h-2 rounded-full bg-secondary"></span>
                        <span class="text-xs font-bold uppercase tracking-wider">Ciclo Académico 2026</span>
                    </div>
                    <h1 class="font-serif text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-4 drop-shadow-sm">
                        Cursos y Simposios: <br />HRAEI 2026
                    </h1>
                    <p class="text-lg md:text-xl text-white/90 font-light mb-8 max-w-lg leading-relaxed">
                        Bienvenidos al portal institucional de enseñanza, planeacion e investigación del HRAEI. Descubra
                        nuestra oferta académica especializada.
                    </p>
                    <div class="flex flex-wrap gap-4">
                        <button
                            class="bg-secondary hover:bg-secondary/90 text-white font-bold py-3 px-6 rounded-lg transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 flex items-center gap-2">
                            Ver catálogo completo
                            <span class="material-symbols-outlined text-sm">arrow_forward</span>
                            <!-- </button>
                                <button class="bg-white/10 hover:bg-white/20 backdrop-blur-md text-white font-semibold py-3 px-6 rounded-lg border border-white/30 transition-all flex items-center gap-2">
        ...
        <section
            class="sticky top-16 md:top-20 z-40 bg-white/80 dark:bg-zinc-900/80 backdrop-blur-md border-b border-gray-200 dark:border-gray-800">
            <div class="max-w-[1280px] mx-auto px-4 md:px-8 py-4">
                <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <!-- Section Title -->
                    <h2 class="font-serif text-xl md:text-2xl font-bold text-primary dark:text-white shrink-0">
                        Catálogo de Cursos
                    </h2>
                    <!-- Filter Chips -->
                    <div class="flex items-center gap-2 overflow-x-auto pb-2 md:pb-0 no-scrollbar mask-linear-fade">
                        <button
                            class="flex items-center gap-2 px-4 py-2 rounded-full bg-primary text-white text-sm font-medium shadow-sm whitespace-nowrap transition-transform hover:scale-105">
                            <span class="material-symbols-outlined text-[18px]">apps</span>
                            Todos
                        </button>
                        <button
                            class="flex items-center gap-2 px-4 py-2 rounded-full bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-700 text-sm font-medium whitespace-nowrap transition-colors">
                        ...
                        <button
                            class="flex items-center gap-2 px-4 py-2 rounded-full bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-700 text-sm font-medium whitespace-nowrap transition-colors">
                            <span class="material-symbols-outlined text-[18px]">podium</span>
                            Simposios
                        </button>
                        <button
                            class="flex items-center gap-2 px-4 py-2 rounded-full bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-700 text-sm font-medium whitespace-nowrap transition-colors">
                    ...
                    <!-- Filter Dropdown Trigger (Mobile only mainly, or extra filters) -->
        ...
        <!-- Course Grid Section -->
        <section class="max-w-[1280px] mx-auto px-4 md:px-8 py-8 md:py-12">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 md:gap-8">

                <?php while ($curso = $resultado->fetch_assoc()) { ?>

                    <article
                        class="group bg-white dark:bg-zinc-800 rounded-xl overflow-hidden shadow-sm hover:shadow-xl hover:shadow-primary/10 border border-gray-100 dark:border-zinc-700 transition-all duration-300 flex flex-col h-full">
                        ...
                        <div class="relative h-48 overflow-hidden">
                            ...
                            <div
                                class="absolute top-3 left-3 bg-primary text-white text-xs font-bold px-2.5 py-1 rounded shadow-sm">
                                <?php echo $curso['tipo']; ?>
                            </div>

                            <?php if ($curso['disponible'] == 'SI') { ?>
                                <div class="absolute top-3 right-3 bg-green-600 text-white text-xs font-bold px-2.5 py-1 rounded shadow-sm">
                                    Disponible
                                </div>
                            <?php } else { ?>
                                <div class="absolute top-3 right-3 bg-gray-600 text-white text-xs font-bold px-2.5 py-1 rounded shadow-sm">
                                    No disponible
                                </div>
                            <?php } ?>
                        ...
                        <div class="p-5 flex flex-col flex-grow">
                            ...
                            <div class="flex items-center gap-2 mb-2 text-xs font-medium text-gray-500 dark:text-gray-400">
                            ...
                            <div class="mt-auto pt-4 border-t border-gray-100 dark:border-zinc-700 flex items-center justify-between">
                                ...
                                <button onclick="window.location.href='Inscripcion.php?id=<?php echo $curso['id']; ?>'"
                                    class="text-primary dark:text-rose-300 font-bold text-sm hover:underline flex items-center gap-1">
                                    Ver más
            ...
            <div class="mt-12 flex justify-center">
                <button
                    class="group flex items-center gap-2 px-6 py-3 rounded-lg border border-gray-300 dark:border-zinc-700 text-gray-700 dark:text-gray-300 font-semibold hover:bg-gray-50 dark:hover:bg-zinc-800 transition-colors">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
                <div>
                    ...
                    <ul class="space-y-2 text-sm text-white/70">
                        <li><a href="https://www.facebook.com/share/14VLkV9scHQ/?mibextid=wwXIfr" target="_blank"
                                class="hover:text-white hover:underline decoration-secondary underline-offset-4">Facebook</a>
                        </li>
                        <li><a href="https://www.instagram.com/hrae.ixtapaluca?igsh=Z3Ryd3VqbmQ2eWdm" target="_blank"
                                class="hover:text-white hover:underline decoration-secondary underline-offset-4">Instagram</a>
                        </li>
                        <li><a href="https://x.com/HRAEIxtapaluca?t=v-f7qiSr3yUbD7wdf7V0wA&s=08" target="_blank"
                                class="hover:text-white hover:underline decoration-secondary underline-offset-4">Twitter</a>
                        </li>
                        <li><a href="https://www.youtube.com/@hraeixtapaluca3460" target="_blank"
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-sm text-white/70">
                        <li><a class="hover:text-white hover:underline decoration-secondary underline-offset-4"
                                href="#">Sobre Nosotros</a></li>
                        <li><a class="hover:text-white hover:underline decoration-secondary underline-offset-4"
                                href="#">Directorio</a></li>
